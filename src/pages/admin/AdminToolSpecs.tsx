...
const toolSpecs = [
  ...
  },
  {
    ...
    status: "Production",
    description:
      "Advanced specification generator for cutting-edge projects. Guides clients through an interactive checklist to select advanced features (AI/ML, real-time infrastructure, security & compliance, performance & scale) and generates comprehensive AI-powered technical blueprints.",
    techStack: {
      frontend: ["React", "TypeScript", "ReactMarkdown", "Tabs UI", "Interactive Checklist"],
      ai: ["Gemini 2.5 Flash (Blueprint Generation)", "Gemini 2.5 Flash (AI Recommendations)"],
      backend: ["2 Edge Functions", "SSE Streaming", "Lovable Cloud (PostgreSQL)"],
    },
    features: [
      "Multi-tab wizard: Project Setup → Advanced Features → Notes → Blueprint",
      "5 project types: Web App, Mobile App, Full-Stack Platform, SaaS, API Service",
      "5 target platforms: Web, iOS, Android, Desktop, API Only",
      "24 advanced features across 4 categories (AI/ML, Real-Time & Infra, Security & Compliance, Performance & Scale)",
      "Interactive feature checklist with toggle selection and category counters",
      "AI-Powered Recommendations: suggests complementary features based on current selections",
      "One-click apply of AI suggestions to feature selections",
      "Real-time SSE streaming of Quantum Blueprint generation",
      "12-section technical blueprint: Executive Summary, Tech Stack, Data Architecture, API Design, Security Framework, Infrastructure, AI/ML Pipeline, Performance Targets, Roadmap, Cost Estimation, and more",
      "Markdown-rendered output with scroll area",
      "Auto-saves generated blueprints to database with full metadata",
      "Additional requirements text input for client-specific notes",
      "Selection summary with project details before generation",
    ],
    dataFlow: [
      "1. User configures project: name, type, target platforms",
      "2. User selects advanced features from interactive checklist (24 options across 4 categories)",
      "3. Optionally: AI recommends complementary features via `quantum-recommend` edge function",
      "4. User adds additional notes/requirements",
      "5. Configuration payload sent to `quantum-spec` edge function",
      "6. Gemini 2.5 Flash generates comprehensive 12-section technical blueprint",
      "7. Response streamed via SSE to frontend, rendered as Markdown in real-time",
      "8. Completed blueprint auto-saved to `generated_reports` table with full metadata (project type, platforms, selected features, notes)",
    ],
    endpoints: [
      {
        name: "quantum-spec",
        method: "POST",
        model: "Gemini 2.5 Flash",
        input: "projectName, projectType, platforms[], selectedFeatures{category: features[]}, additionalNotes",
        output: "SSE stream → 12-section Markdown blueprint",
      },
      {
        name: "quantum-recommend",
        method: "POST",
        model: "Gemini 2.5 Flash",
        input: "projectName, projectType, platforms[], currentSelections{}, availableFeatures[], additionalNotes",
        output: "JSON → {recommendations: [{label, reason}]}",
      },
    ],
    database: [
      "Table: `generated_reports` — stores completed blueprints",
      "report_type: 'quantum-blueprint'",
      "metadata (jsonb): projectType, platforms[], selectedFeatures{}, additionalNotes",
      "Visible in admin Client Blueprints page with full metadata drill-down",
    ],
    security: [
      "Authenticated users only (ProtectedRoute)",
      "Bearer token auth on both edge functions",
      "RLS on generated_reports: users read own, admins read all",
      "LOVABLE_API_KEY for AI gateway (server-side only)",
    ],
  },
  {
