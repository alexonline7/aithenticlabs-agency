...
import { Sparkles, Globe, Smartphone, ShoppingCart, Cloud, ArrowRight, Star, Zap, Quote } from "lucide-react";
...
const portfolio = [
  { cat: "SaaS", title: "Enterprise CRM Platform", desc: "Complete customer relationship management system with AI-powered insights and automation.", techs: ["React", "Node.js", "PostgreSQL", "AI/ML"] },
  { cat: "E-commerce", title: "E-commerce Marketplace", desc: "Multi-vendor marketplace platform with advanced search, payments, and vendor management.", techs: ["Next.js", "Supabase", "Stripe", "Redis"] },
  { cat: "Mobile", title: "Mobile Fitness App", desc: "Cross-platform fitness tracking app with social features and personalized workouts.", techs: ["React Native", "Firebase", "TensorFlow", "Redux"] },
];
    ...
    <div className="min-h-screen luxury-gradient">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Link to="/auth">
              <Button className="h-12 px-8 text-lg bg-gradient-to-r from-deep-gold-500 to-electric-blue-500 text-charcoal-900 font-bold hover:opacity-90 shadow-lg">
                Get AI Recommendation <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            ...
            <Link to="/flash-apps">
              <Button variant="outline" className="h-12 px-8 text-lg border-electric-blue-500/30 text-electric-blue-500 hover:bg-electric-blue-500/10">
                ⚡ Try FlashApps - 8-15 Second Quantum Generation
              </Button>
            </Link>
          </div>
      ...
      <section id="portfolio" className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">Discover the innovative solutions we've created for businesses across industries</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {portfolio.map((p) => (
              <Card key={p.title} className="dark-slate-purple-card glass-effect hover:border-deep-gold-500/30 transition-all duration-300">
                <CardHeader>
                  <span className="text-xs font-semibold text-deep-gold-500 mb-1">{p.cat}</span>
      ...
      <section id="contact" className="py-20 px-4">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold font-bricolage text-slate-100 mb-4">Get Your Personalized App Recommendation</h2>
          <p className="text-slate-400 mb-8">Our AI will analyze your business needs and recommend the perfect digital solution in minutes</p>
          <Link to="/auth">
            <Button className="h-14 px-10 text-lg bg-gradient-to-r from-deep-gold-500 to-electric-blue-500 text-charcoal-900 font-bold hover:opacity-90 shadow-xl">
              Start Your Free Consultation <Sparkles className="ml-2 h-5 w-5" />
            </Button>
          </Link>
        </div>
      </section>
